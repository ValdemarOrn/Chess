...
namespace Chess.Lib.MoveClasses
{
	public sealed class Rook
	{
		...
		[DllImport("C:\\Src\\_Tree\\Applications\\Chess\\Chess.Lib\\x64\\bin\\Chess.Lib.dll", EntryPoint = "Rook_SetupTables", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		static extern void SetupTables();

		[DllImport("C:\\Src\\_Tree\\Applications\\Chess\\Chess.Lib\\x64\\bin\\Chess.Lib.dll", EntryPoint = "Rook_Load", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		static extern int Load(int pos, ulong permutation, ulong moveBoard);

		[DllImport("C:\\Src\\_Tree\\Applications\\Chess\\Chess.Lib\\x64\\bin\\Chess.Lib.dll", EntryPoint = "Rook_LoadVector", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		static extern int LoadVector(int pos, ulong moveBoard);

		[DllImport("C:\\Src\\_Tree\\Applications\\Chess\\Chess.Lib\\x64\\bin\\Chess.Lib.dll", EntryPoint = "Rook_Read", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
