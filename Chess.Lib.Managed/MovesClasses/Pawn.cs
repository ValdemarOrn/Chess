...
namespace Chess.Lib.MoveClasses
{
	public sealed class Pawn
	{
		...
		[DllImport("Chess.Lib.dll", EntryPoint = "Pawn_LoadWhiteMove", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		static extern void LoadWhiteMove(int pos, ulong moveBoard);

		[DllImport("Chess.Lib.dll", EntryPoint = "Pawn_LoadBlackMove", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		static extern void LoadBlackMove(int pos, ulong moveBoard);

		[DllImport("Chess.Lib.dll", EntryPoint = "Pawn_LoadWhiteAttack", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		static extern void LoadWhiteAttack(int pos, ulong moveBoard);

		[DllImport("Chess.Lib.dll", EntryPoint = "Pawn_LoadBlackAttack", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		static extern void LoadBlackAttack(int pos, ulong moveBoard);

		// ---------------------------------------------

		[DllImport("Chess.Lib.dll", EntryPoint = "Pawn_ReadWhiteMove", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong ReadWhiteMove(int pos);

		[DllImport("Chess.Lib.dll", EntryPoint = "Pawn_ReadBlackMove", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong ReadBlackMove(int pos);

		[DllImport("Chess.Lib.dll", EntryPoint = "Pawn_ReadWhiteAttack", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern ulong ReadWhiteAttack(int pos);

		[DllImport("Chess.Lib.dll", EntryPoint = "Pawn_ReadBlackAttack", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
