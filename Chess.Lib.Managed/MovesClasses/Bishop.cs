...
namespace Chess.Lib.MoveClasses
{
	public sealed class Bishop
	{
		...
		[DllImport("..\\..\\..\\Chess.Lib\\x64\\bin\\Chess.Lib.dll", EntryPoint = "Bishop_SetupTables", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		static extern void SetupTables();

		[DllImport("..\\..\\..\\Chess.Lib\\x64\\bin\\Chess.Lib.dll", EntryPoint = "Bishop_Load", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		static extern int Load(int pos, ulong permutation, ulong moveBoard);

		[DllImport("..\\..\\..\\Chess.Lib\\x64\\bin\\Chess.Lib.dll", EntryPoint = "Bishop_LoadVector", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
		static extern int LoadVector(int pos, ulong moveBoard);

		[DllImport("..\\..\\..\\Chess.Lib\\x64\\bin\\Chess.Lib.dll", EntryPoint = "Bishop_Read", SetLastError = false, CallingConvention = CallingConvention.Cdecl)]
