...
namespace Chess.Lib.Tests
{
	...
	public class MovePawnBlackTests
	{
		...
		public unsafe void TestBlackPawnSingle1()
		{
			...
			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 53);
			b->Black = Bitboard.Bitboard_Set((b->Black), 53);
		...
		public unsafe void TestBlackPawnSingle2()
		{
			...
			b->Black = Bitboard.Bitboard_Set((b->Black), 35);
		...
		{
			BoardStruct* b = (BoardStruct*)Board.Board_Create();
			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 15);
			b->Black = Bitboard.Bitboard_Set((b->Black), 15);
		...
		public unsafe void TestBlackPawnCapture2()
		{
			...
			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 35 - 7);
			b->White = Bitboard.Bitboard_Set((b->White), 35 - 7);

			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 35 - 9);
			b->White = Bitboard.Bitboard_Set((b->White), 35 - 9);
		...
		public unsafe void TestBlackPawnCapture4()
		{
			...
			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 6);
			b->White = Bitboard.Bitboard_Set((b->White), 6);
		...
		public unsafe void TestBlackPawnSame1()
		{
			...
			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 46);
			b->Black = Bitboard.Bitboard_Set((b->Black), 46);
		...
		public unsafe void TestBlackPawnSame2()
		{
			...
			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 35 - 7);
			b->Black = Bitboard.Bitboard_Set((b->Black), 35 - 7);

			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 35 - 9);
			b->Black = Bitboard.Bitboard_Set((b->Black), 35 - 9);
		...
		public unsafe void TestBlackPawnSame4()
		{
			...
			b->Black = Bitboard.Bitboard_Set((b->Black), 8);

			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 1);
			b->Black = Bitboard.Bitboard_Set((b->Black), 1);
		...
		{
			BoardStruct* b = (BoardStruct*)Board.Board_Create();
			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 42);
			b->Black = Bitboard.Bitboard_Set((b->Black), 42);

			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 34);
			b->White = Bitboard.Bitboard_Set((b->White), 34);
		...
		public unsafe void TestBlackBlockedBlack()
		{
			...
			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 34);
			b->Black = Bitboard.Bitboard_Set((b->Black), 34);
