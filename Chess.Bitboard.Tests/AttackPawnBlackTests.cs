...
namespace Chess.Lib.Tests
{
	...
	public class AttackPawnBlackTests
	{
		...
		public unsafe void TestBlackPawnCapture1()
		{
			...
			b->Black = Bitboard.Bitboard_Set((b->Black), 55);

			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 46);
			b->White = Bitboard.Bitboard_Set((b->White), 46);
		...
		{
			BoardStruct* b = (BoardStruct*)Board.Board_Create();
			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 48);
			b->Black = Bitboard.Bitboard_Set((b->Black), 48);

			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 41);
		...
		public unsafe void TestBlackPawnSame4()
		{
			...
			b->Pawns = Bitboard.Bitboard_Set((b->Pawns), 6);
			b->Black = Bitboard.Bitboard_Set((b->Black), 6);
