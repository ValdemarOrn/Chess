...
extern "C"
{
	__dllexport void Bishop_SetupTables();
	__dllexport int Bishop_Load(int pos, uint64_t permutation, uint64_t moveBoard);
	__dllexport void Bishop_LoadVector(int pos, uint64_t moveBoard);
	__dllexport uint64_t Bishop_Read(int pos, uint64_t occupancy);
