...
namespace Chess.Lib.TestPerf
{
	class BasePerftTests
	{
		public static void RunBasePerft()
		{
			...
			var b = Notation.FENtoBoard("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1");
			...
			b = Notation.FENtoBoard("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -");
			...
			b = Notation.FENtoBoard("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -");
			...
			b = Notation.FENtoBoard("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1");
			...
			b = Notation.FENtoBoard("rnbqkb1r/pp1p1ppp/2p5/4P3/2B5/8/PPP1NnPP/RNBQK2R w KQkq - 0 6");
			results = Chess.Base.Perft.RunPerft(b, 3);
